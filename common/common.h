...
struct common_params {
    ...
    int32_t     moe_prefetch_lookahead = 1; // moe-stream-lab: MoE layers of lead                                  // NOLINT
    float       moe_prefetch_margin = 0.0f;  // moe-stream-lab: prefetch confidence margin (0 = fixed top-k)         // NOLINT
